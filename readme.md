...
-   Lister des listes de tâche
-   Ajouter / modifier / Supprimer des listes de tâches
-   Associer une date à une liste
-   Ajouter / modifier / Supprimer des tâches dans une liste
...
Pour ajouter une tâche, cliquez dans le champ de saisie puis nommez votre tâche (ici 'Doner à manger au chat de la voisine').Pressez ensuite la touche entrée ou cliquez sur la petite flèche à gauche du champ pour ajouter la tâche à la liste.
